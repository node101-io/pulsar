...
func init() {
	file_cosmos_minakeys_signing_keys_proto_init()
	md_PubKey = File_cosmos_minakeys_signing_keys_proto.Messages().ByName("PubKey")
...
func (x *PubKey) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_minakeys_signing_keys_proto_msgTypes[0]
...
func (x *fastReflection_PubKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.minakeys.signing.PubKey.key":
		return len(x.Key) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.minakeys.signing.PubKey"))
		}
		panic(fmt.Errorf("message cosmos.minakeys.signing.PubKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PubKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.minakeys.signing.PubKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PubKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.minakeys.signing.PubKey.key":
		panic(fmt.Errorf("field key of message cosmos.minakeys.signing.PubKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.minakeys.signing.PubKey"))
		}
...
func (x *fastReflection_PubKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.minakeys.signing.PubKey", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_minakeys_signing_keys_proto_init()
	md_PrivKey = File_cosmos_minakeys_signing_keys_proto.Messages().ByName("PrivKey")
...
func (x *PrivKey) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_minakeys_signing_keys_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_PrivKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.minakeys.signing.PrivKey.secret":
		return len(x.Secret) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.minakeys.signing.PrivKey"))
		}
		panic(fmt.Errorf("message cosmos.minakeys.signing.PrivKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PrivKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.minakeys.signing.PrivKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PrivKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.minakeys.signing.PrivKey.secret":
		panic(fmt.Errorf("field secret of message cosmos.minakeys.signing.PrivKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.minakeys.signing.PrivKey"))
		}
...
func (x *fastReflection_PrivKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.minakeys.signing.PrivKey", d.FullName()))
	}
	panic("unreachable")
}
...
func (*PubKey) Descriptor() ([]byte, []int) {
	return file_cosmos_minakeys_signing_keys_proto_rawDescGZIP(), []int{0}
}
...
func (*PrivKey) Descriptor() ([]byte, []int) {
	return file_cosmos_minakeys_signing_keys_proto_rawDescGZIP(), []int{1}
}
...
var File_cosmos_minakeys_signing_keys_proto protoreflect.FileDescriptor

var file_cosmos_minakeys_signing_keys_proto_rawDesc = []byte{
	,
}

var (
	file_cosmos_minakeys_signing_keys_proto_rawDescOnce sync.Once
	file_cosmos_minakeys_signing_keys_proto_rawDescData = file_cosmos_minakeys_signing_keys_proto_rawDesc
)

func file_cosmos_minakeys_signing_keys_proto_rawDescGZIP() []byte {
	file_cosmos_minakeys_signing_keys_proto_rawDescOnce.Do(func() {
		file_cosmos_minakeys_signing_keys_proto_rawDescData = protoimpl.X.CompressGZIP(file_cosmos_minakeys_signing_keys_proto_rawDescData)
	})
	return file_cosmos_minakeys_signing_keys_proto_rawDescData
}

var file_cosmos_minakeys_signing_keys_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cosmos_minakeys_signing_keys_proto_goTypes = []interface{}{
	(*PubKey)(nil),  // 0: cosmos.minakeys.signing.PubKey
	(*PrivKey)(nil), // 1: cosmos.minakeys.signing.PrivKey
}
var file_cosmos_minakeys_signing_keys_proto_depIdxs = []int32{
...
func init() { file_cosmos_minakeys_signing_keys_proto_init() }
func file_cosmos_minakeys_signing_keys_proto_init() {
	if File_cosmos_minakeys_signing_keys_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cosmos_minakeys_signing_keys_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PubKey); i {
			case 0:
				return &v.state
			case 1:
		...
		file_cosmos_minakeys_signing_keys_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cosmos_minakeys_signing_keys_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cosmos_minakeys_signing_keys_proto_goTypes,
		DependencyIndexes: file_cosmos_minakeys_signing_keys_proto_depIdxs,
		MessageInfos:      file_cosmos_minakeys_signing_keys_proto_msgTypes,
	}.Build()
	File_cosmos_minakeys_signing_keys_proto = out.File
	file_cosmos_minakeys_signing_keys_proto_rawDesc = nil
	file_cosmos_minakeys_signing_keys_proto_goTypes = nil
	file_cosmos_minakeys_signing_keys_proto_depIdxs = nil
}
