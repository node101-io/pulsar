...
import { ConnectionEnd, IdentifiedConnection } from "@cosmjs/stargate/node_modules/cosmjs-types/ibc/core/connection/v1/connection";
import { Height, IdentifiedClientState, Params } from "@cosmjs/stargate/node_modules/cosmjs-types/ibc/core/client/v1/client";
import { Any } from "@cosmjs/stargate/node_modules/cosmjs-types/google/protobuf/any";
...
export declare const QueryConnectionResponse: {
    ...
    fromPartial<I extends {
        connection?: {
            ...
            state?: import("@cosmjs/stargate/node_modules/cosmjs-types/ibc/core/connection/v1/connection").State | undefined;
            counterparty?: {
                clientId?: string | undefined;
                connectionId?: string | undefined;
                prefix?: {
        ...
        connection?: ({
            ...
            } & Record<Exclude<keyof I["connection"]["versions"][number], keyof import("@cosmjs/stargate/node_modules/cosmjs-types/ibc/core/connection/v1/connection").Version>, never>)[] & Record<Exclude<keyof I["connection"]["versions"], keyof {
                identifier?: string | undefined;
                features?: string[] | undefined;
            }[]>, never>) | undefined;
            state?: import("@cosmjs/stargate/node_modules/cosmjs-types/ibc/core/connection/v1/connection").State | undefined;
            ...
            } & Record<Exclude<keyof I["connection"]["counterparty"], keyof import("@cosmjs/stargate/node_modules/cosmjs-types/ibc/core/connection/v1/connection").Counterparty>, never>) | undefined;
            delayPeriod?: bigint | undefined;
...
export declare const QueryConnectionsResponse: {
    ...
    fromPartial<I extends {
        ...
        connections?: ({
            ...
            } & Record<Exclude<keyof I["connections"][number]["versions"][number], keyof import("@cosmjs/stargate/node_modules/cosmjs-types/ibc/core/connection/v1/connection").Version>, never>)[] & Record<Exclude<keyof I["connections"][number]["versions"], keyof {
                identifier?: string | undefined;
                features?: string[] | undefined;
            }[]>, never>) | undefined;
            state?: import("@cosmjs/stargate/node_modules/cosmjs-types/ibc/core/connection/v1/connection").State | undefined;
            ...
            } & Record<Exclude<keyof I["connections"][number]["counterparty"], keyof import("@cosmjs/stargate/node_modules/cosmjs-types/ibc/core/connection/v1/connection").Counterparty>, never>) | undefined;
            delayPeriod?: bigint | undefined;
