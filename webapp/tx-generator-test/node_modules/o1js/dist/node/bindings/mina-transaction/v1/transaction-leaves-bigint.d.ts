import { Field, Bool, UInt32, UInt64, Sign } from 'o1js/dist/node/mina-signer/src/field-bigint.js';
import { PublicKey } from 'o1js/dist/node/mina-signer/src/curve-bigint.js';
...
declare const TokenId: Omit<{
    ...
    toInput({ field }: {
        symbol: string;
        field: bigint;
    }): import("o1js/dist/node/bindings/lib/generic.js").GenericHashInput<bigint>;
    toJSON({ symbol }: {
        symbol: string;
        field: bigint;
    }): string;
    ...
    toJSON(x: {
        ...
        signatureNecessary: boolean;
        signatureSufficient: boolean;
    }): import("o1js/dist/node/bindings/mina-transaction/v1/transaction-leaves-json.js").AuthRequired;
    fromJSON(json: import("o1js/dist/node/bindings/mina-transaction/v1/transaction-leaves-json.js").AuthRequired): {
        constant: boolean;
        signatureNecessary: boolean;
        signatureSufficient: boolean;
    };
}, ZkappUri: import("o1js/dist/node/bindings/lib/generic.js").GenericProvableExtended<{
    data: string;
    hash: bigint;
}, {
    data: string;
...
declare const ActionState: {
    ...
    readBytes<N extends number>(bytes: number[], offset: import("o1js/dist/node/bindings/crypto/non-negative.js").NonNegativeInteger<N>): [value: bigint, offset: number];
...
declare const TransactionVersion: {
    empty: () => bigint;
    toInput(x: bigint): import("o1js/dist/node/mina-signer/src/derivers-bigint.js").HashInput;
    maxValue: bigint;
    random(): bigint;
    toBytes(t: bigint): number[];
    readBytes<N extends number>(bytes: number[], offset: import("o1js/dist/node/bindings/crypto/non-negative.js").NonNegativeInteger<N>): [value: bigint, offset: number];
