import { Field } from 'o1js/dist/node/mina-signer/src/field-bigint.js';
import { Group, Scalar, PrivateKey, PublicKey } from 'o1js/dist/node/mina-signer/src/curve-bigint.js';
import { HashInput, HashInputLegacy } from 'o1js/dist/node/mina-signer/src/poseidon-bigint.js';
import { NetworkId } from 'o1js/dist/node/mina-signer/src/types.js';
export { sign, verify, signFieldElement, verifyFieldElement, Signature, SignatureJson, signLegacy, verifyLegacy, deriveNonce, signaturePrefix, zkAppBodyPrefix, };
type Signature = {
    r: Field;
    s: Scalar;
};
