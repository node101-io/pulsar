...
import { AccountUpdate, AccountUpdateForest, AccountUpdateTree } from 'o1js/dist/node/lib/mina/v1/account-update.js';
import { DeployArgs, SmartContract } from 'o1js/dist/node/lib/mina/v1/zkapp.js';
...
declare abstract class TokenContract extends SmartContract {
     ...
     */
    deriveTokenId(): import("o1js/dist/node/lib/provable/field.js").Field;
    /**
