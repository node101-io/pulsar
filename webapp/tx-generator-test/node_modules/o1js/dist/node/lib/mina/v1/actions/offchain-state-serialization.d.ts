 ...
 */
import { ProvablePure, WithProvable } from 'o1js/dist/node/lib/provable/types/provable-intf.js';
...
import { MerkleList } from 'o1js/dist/node/lib/provable/merkle-list.js';
...
declare const MerkleLeaf_base: (new (value: {
    ...
    usesPreviousValue: import("o1js/dist/node/lib/provable/bool.js").Bool;
    previousValue: import("o1js/dist/node/lib/provable/field.js").Field;
    prefix: Unconstrained<import("o1js/dist/node/lib/provable/field.js").Field[]>;
}) => {
    key: import("o1js/dist/node/lib/provable/field.js").Field;
    value: import("o1js/dist/node/lib/provable/field.js").Field;
    usesPreviousValue: import("o1js/dist/node/lib/provable/bool.js").Bool;
    ...
    prefix: import("o1js/dist/node/lib/provable/field.js").Field[];
}> & {
    fromValue: (value: {
        key: string | number | bigint | import("o1js/dist/node/lib/provable/field.js").Field;
        value: string | number | bigint | import("o1js/dist/node/lib/provable/field.js").Field;
        usesPreviousValue: boolean | import("o1js/dist/node/lib/provable/bool.js").Bool;
        previousValue: string | number | bigint | import("o1js/dist/node/lib/provable/field.js").Field;
        prefix: import("o1js/dist/node/lib/provable/field.js").Field[] | Unconstrained<import("o1js/dist/node/lib/provable/field.js").Field[]>;
    }) => {
        key: import("o1js/dist/node/lib/provable/field.js").Field;
        value: import("o1js/dist/node/lib/provable/field.js").Field;
        usesPreviousValue: import("o1js/dist/node/lib/provable/bool.js").Bool;
...
declare class MerkleLeaf extends MerkleLeaf_base {
     ...
     */
    static hash(action: MerkleLeaf): import("o1js/dist/node/lib/provable/field.js").Field;
}
declare const ActionList_base: {
    ...
    create<T>(type: WithProvable<ProvableHashable<T>>, nextHash?: (hash: import("o1js/dist/node/lib/provable/field.js").Field, value: T) => import("o1js/dist/node/lib/provable/field.js").Field, emptyHash_?: import("o1js/dist/node/lib/provable/field.js").Field): typeof MerkleList<T> & {
        empty: () => MerkleList<T>;
...
declare const LinearizedAction_base: (new (value: {
    action: MerkleLeaf;
    isCheckPoint: import("o1js/dist/node/lib/provable/bool.js").Bool;
}) => {
    action: MerkleLeaf;
    isCheckPoint: import("o1js/dist/node/lib/provable/bool.js").Bool;
}) & {
    ...
    fromValue: (value: {
        ...
        isCheckPoint: boolean | import("o1js/dist/node/lib/provable/bool.js").Bool;
    }) => {
        action: MerkleLeaf;
        isCheckPoint: import("o1js/dist/node/lib/provable/bool.js").Bool;
    };
...
declare class LinearizedAction extends LinearizedAction_base {
     ...
     * the rest of the action.
     */
    static hash({ action, isCheckPoint }: LinearizedAction): import("o1js/dist/node/lib/provable/field.js").Field;
}
