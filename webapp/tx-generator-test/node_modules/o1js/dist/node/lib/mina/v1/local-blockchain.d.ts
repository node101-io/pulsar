...
import { Transaction, PendingTransactionPromise } from 'o1js/dist/node/lib/mina/v1/transaction.js';
import { type FeePayerSpec, type ActionStates } from 'o1js/dist/node/lib/mina/v1/mina-instance.js';
...
declare function LocalBlockchain({ proofsEnabled, enforceTransactionLimits }?: {
    ...
    transaction(sender: FeePayerSpec, f: () => Promise<void>): import("o1js/dist/node/lib/mina/v1/transaction.js").TransactionPromise<false, false>;
