import { SelfProof } from 'o1js/dist/node/lib/proof-system/zkprogram.js';
import { Proof } from 'o1js/dist/node/lib/proof-system/proof.js';
import { Bool, Field } from 'o1js/dist/node/lib/provable/wrapped.js';
import { SmartContract } from 'o1js/dist/node/lib/mina/v1/zkapp.js';
import { Constructor, From } from 'o1js/dist/node/bindings/lib/provable-generic.js';
...
import { State } from 'o1js/dist/node/lib/mina/v1/state.js';
import { Unconstrained } from 'o1js/dist/node/lib/provable/types/unconstrained.js';
import { MerkleActions } from 'o1js/dist/node/lib/mina/v1/actions/action-types.js';
import { ProvableHashable, ProvablePure } from 'o1js/dist/node/lib/provable/types/provable-intf.js';
...
declare class BatchReducer<ActionType extends Actionable<any>, BatchSize extends number = number, Action = InferProvable<ActionType>> {
    ...
    static get initialActionState(): import("o1js/dist/node/lib/provable/field.js").Field;
    static get initialActionStack(): import("o1js/dist/node/lib/provable/field.js").Field;
...
declare function ActionBatch<A extends Actionable<any>>(actionType: A): (new (value: {
    useOnchainStack: import("o1js/dist/node/lib/provable/bool.js").Bool;
    processedActionState: import("o1js/dist/node/lib/provable/field.js").Field;
    onchainActionState: import("o1js/dist/node/lib/provable/field.js").Field;
    onchainStack: import("o1js/dist/node/lib/provable/field.js").Field;
    stack: import("o1js/dist/node/lib/provable/merkle-list.js").MerkleList<import("o1js/dist/node/lib/provable/merkle-list.js").MerkleList<import("o1js/dist/node/lib/provable/packed.js").Hashed<import("o1js/dist/node/bindings/lib/provable-generic.js").InferProvable<A, import("o1js/dist/node/lib/provable/field.js").Field>>>>;
    isRecursive: import("o1js/dist/node/lib/provable/bool.js").Bool;
    witnesses: Unconstrained<ActionWitnesses>;
}) => {
    useOnchainStack: import("o1js/dist/node/lib/provable/bool.js").Bool;
    processedActionState: import("o1js/dist/node/lib/provable/field.js").Field;
    ...
    fromValue: (value: {
        useOnchainStack: boolean | import("o1js/dist/node/lib/provable/bool.js").Bool;
        processedActionState: string | number | bigint | import("o1js/dist/node/lib/provable/field.js").Field;
        onchainActionState: string | number | bigint | import("o1js/dist/node/lib/provable/field.js").Field;
        onchainStack: string | number | bigint | import("o1js/dist/node/lib/provable/field.js").Field;
        stack: any;
        isRecursive: boolean | import("o1js/dist/node/lib/provable/bool.js").Bool;
...
declare const ActionStackState_base: (new (value: {
    actions: import("o1js/dist/node/lib/provable/field.js").Field;
    stack: import("o1js/dist/node/lib/provable/field.js").Field;
}) => {
    actions: import("o1js/dist/node/lib/provable/field.js").Field;
    stack: import("o1js/dist/node/lib/provable/field.js").Field;
}) & {
    ...
    fromValue: (value: {
        actions: string | number | bigint | import("o1js/dist/node/lib/provable/field.js").Field;
        stack: string | number | bigint | import("o1js/dist/node/lib/provable/field.js").Field;
    }) => {
        actions: import("o1js/dist/node/lib/provable/field.js").Field;
        stack: import("o1js/dist/node/lib/provable/field.js").Field;
    };
...
declare function actionStackProgram(maxUpdatesPerProof: number): {
    ...
    verify: (proof: Proof<import("o1js/dist/node/lib/provable/field.js").Field, ActionStackState>) => Promise<boolean>;
    digest: () => Promise<string>;
    analyzeMethods: () => Promise<{
        proveChunk: import("o1js/dist/node/lib/provable/core/provable-context.js").ConstraintSystemSummary & {
            proofs: import("o1js/dist/node/lib/proof-system/proof.js").ProofClass[];
        };
    }>;
    analyzeSingleMethod<K extends "proveChunk">(methodName: K): Promise<import("o1js/dist/node/lib/provable/core/provable-context.js").ConstraintSystemSummary & {
        proofs: import("o1js/dist/node/lib/proof-system/proof.js").ProofClass[];
    }>;
    ...
    publicOutputType: typeof ActionStackState;
    privateInputTypes: {
        proveChunk: [typeof SelfProof, typeof import("o1js/dist/node/lib/provable/bool.js").Bool & ((x: boolean | import("o1js/dist/node/lib/provable/core/fieldvar.js").FieldVar | import("o1js/dist/node/lib/provable/bool.js").Bool) => import("o1js/dist/node/lib/provable/bool.js").Bool), Provable<Unconstrained<ActionWitnesses>, ActionWitnesses> & {
    ...
    rawMethods: {
        proveChunk: (publicInput: import("o1js/dist/node/lib/provable/field.js").Field, args_0: SelfProof<unknown, unknown>, args_1: import("o1js/dist/node/lib/provable/bool.js").Bool, args_2: Unconstrained<ActionWitnesses>) => Promise<{
    ...
    Proof: {
        ...
        }): Proof<import("o1js/dist/node/lib/provable/field.js").Field, ActionStackState>;
        fromJSON<S extends import("o1js/dist/node/lib/util/types.js").Subclass<typeof Proof>>(this: S, { maxProofsVerified, proof: proofString, publicInput: publicInputJson, publicOutput: publicOutputJson, }: import("o1js/dist/node/lib/proof-system/zkprogram.js").JsonProof): Promise<Proof<InferProvable<S["publicInputType"]>, InferProvable<S["publicOutputType"]>>>;
        ...
        publicInputType: import("o1js/dist/node/lib/provable/types/struct.js").FlexibleProvable<any>;
        publicOutputType: import("o1js/dist/node/lib/provable/types/struct.js").FlexibleProvable<any>;
        tag: () => {
            name: string;
        };
        publicFields(value: import("o1js/dist/node/lib/proof-system/proof.js").ProofBase<any, any>): {
    ...
    proveChunk: (publicInput: string | number | bigint | import("o1js/dist/node/lib/provable/field.js").Field, args_0: Proof<any, any> | import("o1js/dist/node/lib/proof-system/proof.js").ProofValue<any, any>, args_1: boolean | import("o1js/dist/node/lib/provable/bool.js").Bool, args_2: ActionWitnesses | Unconstrained<ActionWitnesses>) => Promise<{
        proof: Proof<import("o1js/dist/node/lib/provable/field.js").Field, ActionStackState>;
