...
import { Gate, Pickles } from 'o1js/dist/node/bindings.js';
import { Field, Bool } from 'o1js/dist/node/lib/provable/wrapped.js';
import { AccountUpdate, ZkappPublicInput, AccountUpdateForest, AccountUpdateTree } from 'o1js/dist/node/lib/mina/v1/account-update.js';
import { FlexibleProvablePure, InferProvable } from 'o1js/dist/node/lib/provable/types/struct.js';
import { Provable } from 'o1js/dist/node/lib/provable/provable.js';
import { UInt32, UInt64 } from 'o1js/dist/node/lib/provable/int.js';
import { MethodInterface } from 'o1js/dist/node/lib/proof-system/zkprogram.js';
import { Proof, ProofClass } from 'o1js/dist/node/lib/proof-system/proof.js';
...
import { SmartContractBase } from 'o1js/dist/node/lib/mina/v1/smart-contract-base.js';
import { ProvablePure, ProvableType } from 'o1js/dist/node/lib/provable/types/provable-intf.js';
...
declare class SmartContract extends SmartContractBase {
    ...
    static Proof(): {
        ...
        publicInputType: Omit<import("o1js/dist/node/lib/provable/types/provable-intf.js").Provable<{
        ...
        publicOutputType: import("o1js/dist/node/lib/provable/types/struct.js").ProvablePureExtended<undefined, undefined, null>;
    ...
    static compile({ cache, forceRecompile }?: {
        ...
        verify: (statement: Pickles.Statement<import("o1js/dist/node/lib/provable/core/fieldvar.js").FieldConst>, proof: unknown) => Promise<boolean>;
    }>;
    /**
     ...
     */
    get account(): import("o1js/dist/node/lib/mina/v1/precondition.js").Account;
    /**
     * Current network state of the {@link SmartContract}.
     */
    get network(): import("o1js/dist/node/lib/mina/v1/precondition.js").Network;
    /**
     ...
     */
    get currentSlot(): import("o1js/dist/node/lib/mina/v1/precondition.js").CurrentSlot;
    /**
     ...
     */
    get balance(): {
        addInPlace(x: string | number | bigint | UInt64 | UInt32 | import("o1js/dist/node/lib/provable/int.js").Int64): void;
        subInPlace(x: string | number | bigint | UInt64 | UInt32 | import("o1js/dist/node/lib/provable/int.js").Int64): void;
    };
    /**
