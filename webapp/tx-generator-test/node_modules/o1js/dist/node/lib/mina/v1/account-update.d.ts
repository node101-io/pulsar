import { FlexibleProvable } from 'o1js/dist/node/lib/provable/types/struct.js';
import { Provable } from 'o1js/dist/node/lib/provable/provable.js';
import { Field, Bool } from 'o1js/dist/node/lib/provable/wrapped.js';
import { Types } from 'o1js/dist/node/bindings/mina-transaction/v1/types.js';
import { PrivateKey, PublicKey } from 'o1js/dist/node/lib/provable/crypto/signature.js';
import { UInt64, UInt32, Int64 } from 'o1js/dist/node/lib/provable/int.js';
import type { SmartContract } from 'o1js/dist/node/lib/mina/v1/zkapp.js';
import { Preconditions, Account, Network, CurrentSlot, OrIgnore, ClosedInterval } from 'o1js/dist/node/lib/mina/v1/precondition.js';
import { Empty } from 'o1js/dist/node/lib/proof-system/zkprogram.js';
import { Proof } from 'o1js/dist/node/lib/proof-system/proof.js';
import { Events as BaseEvents, Actions as BaseActions, MayUseToken as BaseMayUseToken } from 'o1js/dist/node/bindings/mina-transaction/v1/transaction-leaves.js';
import { CallForest } from 'o1js/dist/node/mina-signer/src/sign-zkapp-command.js';
import { MerkleList, MerkleListBase } from 'o1js/dist/node/lib/provable/merkle-list.js';
import { Hashed } from 'o1js/dist/node/lib/provable/packed.js';
...
declare const MayUseToken: {
    type: {
        ...
        toFields: (x: {
            parentsOwnToken: import("o1js/dist/node/lib/provable/bool.js").Bool;
            inheritFromParent: import("o1js/dist/node/lib/provable/bool.js").Bool;
        ...
        fromFields: (x: import("o1js/dist/node/lib/provable/field.js").Field[]) => {
            parentsOwnToken: import("o1js/dist/node/lib/provable/bool.js").Bool;
            inheritFromParent: import("o1js/dist/node/lib/provable/bool.js").Bool;
        };
        toInput: (x: {
    ...
    isNo: ({ body: { mayUseToken: { parentsOwnToken, inheritFromParent }, }, }: AccountUpdate) => import("o1js/dist/node/lib/provable/bool.js").Bool;
    isParentsOwnToken: (a: AccountUpdate) => import("o1js/dist/node/lib/provable/bool.js").Bool;
    isInheritFromParent: (a: AccountUpdate) => import("o1js/dist/node/lib/provable/bool.js").Bool;
};
type Events = BaseEvents;
declare const Events: {
    pushEvent(events: Events, event: Field[]): Events;
    toFields: (x: {
        data: import("o1js/dist/node/lib/provable/field.js").Field[][];
    ...
    fromFields: (x: import("o1js/dist/node/lib/provable/field.js").Field[], aux: any[]) => {
        data: import("o1js/dist/node/lib/provable/field.js").Field[][];
        hash: import("o1js/dist/node/lib/provable/field.js").Field;
    };
    sizeInFields(): number;
    ...
    fromList(events: import("o1js/dist/node/lib/provable/field.js").Field[][]): {
        hash: import("o1js/dist/node/lib/provable/field.js").Field;
        data: import("o1js/dist/node/lib/provable/field.js").Field[][];
    };
    hash(events: import("o1js/dist/node/lib/provable/field.js").Field[][]): import("o1js/dist/node/lib/provable/field.js").Field;
};
...
declare const Actions: {
    ...
    hash(events: import("o1js/dist/node/lib/provable/field.js").Field[][]): import("o1js/dist/node/lib/provable/field.js").Field;
    emptyActionState(): import("o1js/dist/node/lib/provable/field.js").Field;
    updateSequenceState(state: import("o1js/dist/node/lib/provable/field.js").Field, sequenceEventsHash: import("o1js/dist/node/lib/provable/field.js").Field): import("o1js/dist/node/lib/provable/field.js").Field;
};
/**
...
declare const TokenId: {
    default: import("o1js/dist/node/lib/provable/field.js").Field;
    derive(tokenOwner: PublicKey, parentTokenId?: import("o1js/dist/node/lib/provable/field.js").Field): Field;
    toBase58(t: import("o1js/dist/node/lib/provable/field.js").Field): string;
    fromBase58(base58: string): import("o1js/dist/node/lib/provable/field.js").Field;
    empty: () => import("o1js/dist/node/lib/provable/field.js").Field;
    fromFields: (x: import("o1js/dist/node/lib/provable/field.js").Field[], aux: any[]) => import("o1js/dist/node/lib/provable/field.js").Field;
    toFields: (x: import("o1js/dist/node/lib/provable/field.js").Field) => import("o1js/dist/node/lib/provable/field.js").Field[];
    toAuxiliary: (x?: import("o1js/dist/node/lib/provable/field.js").Field | undefined) => any[];
    sizeInFields: () => number;
    check: (x: import("o1js/dist/node/lib/provable/field.js").Field) => void;
    toValue: (x: import("o1js/dist/node/lib/provable/field.js").Field) => bigint;
    fromValue: (x: bigint | import("o1js/dist/node/lib/provable/field.js").Field) => import("o1js/dist/node/lib/provable/field.js").Field;
    toCanonical?: ((x: import("o1js/dist/node/lib/provable/field.js").Field) => import("o1js/dist/node/lib/provable/field.js").Field) | undefined;
    toInput: (x: import("o1js/dist/node/lib/provable/field.js").Field) => {
        fields?: import("o1js/dist/node/lib/provable/field.js").Field[] | undefined;
        packed?: [import("o1js/dist/node/lib/provable/field.js").Field, number][] | undefined;
    };
    toJSON(x: import("o1js/dist/node/lib/provable/field.js").Field): string;
    fromJSON(x: string): import("o1js/dist/node/lib/provable/field.js").Field;
};
/**
...
declare class AccountUpdate implements Types.AccountUpdate {
    ...
    private isSelf;
    static Actions: {
        pushEvent(actions: Types.Events, action: import("o1js/dist/node/lib/provable/field.js").Field[]): Types.Events;
        toFields: (x: {
            data: import("o1js/dist/node/lib/provable/field.js").Field[][];
            hash: import("o1js/dist/node/lib/provable/field.js").Field;
        }) => import("o1js/dist/node/lib/provable/field.js").Field[];
    ...
    static Events: {
        pushEvent(events: Types.Events, event: import("o1js/dist/node/lib/provable/field.js").Field[]): Types.Events;
        toFields: (x: {
            data: import("o1js/dist/node/lib/provable/field.js").Field[][];
            hash: import("o1js/dist/node/lib/provable/field.js").Field;
        }) => import("o1js/dist/node/lib/provable/field.js").Field[];
    ...
    get tokenId(): import("o1js/dist/node/lib/provable/field.js").Field;
    send({ to, amount, }: {
    ...
    static toFields: (x: Types.AccountUpdate) => import("o1js/dist/node/lib/provable/field.js").Field[];
    ...
    static toValue: (x: Types.AccountUpdate) => import("o1js/dist/node/bindings/mina-transaction/gen/v1/transaction-bigint.js").AccountUpdate;
...
declare function hashAccountUpdate(update: AccountUpdate): import("o1js/dist/node/lib/provable/field.js").Field;
declare const HashedAccountUpdate_base: {
    new (hash: import("o1js/dist/node/lib/provable/field.js").Field, value: import("o1js").Unconstrained<AccountUpdate>): Hashed<AccountUpdate>;
    create<T>(type: import("o1js/dist/node/lib/provable/types/provable-intf.js").WithProvable<import("o1js/dist/node/lib/provable/crypto/poseidon.js").ProvableHashable<T>>, hash?: ((t: T) => import("o1js/dist/node/lib/provable/field.js").Field) | undefined): typeof Hashed<T> & {
        provable: import("o1js/dist/node/lib/provable/crypto/poseidon.js").ProvableHashable<Hashed<T>>;
        empty(): Hashed<T>;
    };
    _hash(_: any): import("o1js/dist/node/lib/provable/field.js").Field;
    hash<T_1>(value: T_1, hash?: import("o1js/dist/node/lib/provable/field.js").Field | undefined): Hashed<T_1>;
    _provable: import("o1js/dist/node/lib/provable/crypto/poseidon.js").ProvableHashable<Hashed<any>> | undefined;
    _innerProvable: import("o1js/dist/node/lib/provable/crypto/poseidon.js").ProvableHashable<any> | undefined;
    readonly innerProvable: import("o1js/dist/node/lib/provable/crypto/poseidon.js").ProvableHashable<any>;
} & {
    provable: import("o1js/dist/node/lib/provable/crypto/poseidon.js").ProvableHashable<Hashed<AccountUpdate>>;
...
declare const AccountUpdateForest_base: {
    ...
    create<T>(type: import("o1js/dist/node/lib/provable/types/provable-intf.js").WithProvable<import("o1js/dist/node/lib/provable/crypto/poseidon.js").ProvableHashable<T>>, nextHash?: (hash: import("o1js/dist/node/lib/provable/field.js").Field, value: T) => import("o1js/dist/node/lib/provable/field.js").Field, emptyHash_?: import("o1js/dist/node/lib/provable/field.js").Field): typeof MerkleList<T> & {
        empty: () => MerkleList<T>;
        from: (array: T[]) => MerkleList<T>;
        fromReverse: (array: T[]) => MerkleList<T>;
        provable: import("o1js/dist/node/lib/provable/crypto/poseidon.js").ProvableHashable<MerkleList<T>>;
    };
    ...
    _provable: import("o1js/dist/node/lib/provable/crypto/poseidon.js").ProvableHashable<MerkleList<any>> | undefined;
    _innerProvable: import("o1js/dist/node/lib/provable/crypto/poseidon.js").ProvableHashable<any> | undefined;
    ...
    provable: import("o1js/dist/node/lib/provable/crypto/poseidon.js").ProvableHashable<MerkleList<{
        id: number;
        accountUpdate: Hashed<AccountUpdate>;
        children: MerkleListBase<AccountUpdateTreeBase>;
    }>>;
...
declare class AccountUpdateForest extends AccountUpdateForest_base {
    static provable: {
        ...
        fromFields(fields: import("o1js/dist/node/lib/provable/field.js").Field[], aux: any[]): AccountUpdateForest;
...
declare let ZkappPublicInput: Omit<import("o1js/dist/node/lib/provable/types/provable-intf.js").Provable<{
    accountUpdate: import("o1js/dist/node/lib/provable/field.js").Field;
    calls: import("o1js/dist/node/lib/provable/field.js").Field;
}, {
