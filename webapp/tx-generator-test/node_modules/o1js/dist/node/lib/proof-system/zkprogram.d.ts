import { Base64ProofString, Base64VerificationKeyString } from 'o1js/dist/node/bindings.js';
import { Pickles, Gate } from 'o1js/dist/node/bindings.js';
import { Field } from 'o1js/dist/node/lib/provable/wrapped.js';
import { FlexibleProvable, InferProvable, ProvablePureExtended } from 'o1js/dist/node/lib/provable/types/struct.js';
import { InferProvableType } from 'o1js/dist/node/lib/provable/types/provable-derivers.js';
...
import { FieldConst } from 'o1js/dist/node/lib/provable/core/fieldvar.js';
import { Cache } from 'o1js/dist/node/lib/proof-system/cache.js';
import { ProvableType, ToProvable } from 'o1js/dist/node/lib/provable/types/provable-intf.js';
import { Subclass, Tuple } from 'o1js/dist/node/lib/util/types.js';
import { Proof, ProofBase, ProofClass, ProofValue } from 'o1js/dist/node/lib/proof-system/proof.js';
...
declare namespace ZkProgram {
    var Proof: <PublicInputType extends FlexibleProvable<any>, PublicOutputType extends FlexibleProvable<any>>(program: {
        ...
        fromJSON<S extends Subclass<typeof import("o1js/dist/node/lib/proof-system/proof.js").Proof>>(this: S, { maxProofsVerified, proof: proofString, publicInput: publicInputJson, publicOutput: publicOutputJson, }: JsonProof): Promise<Proof<InferProvable<S["publicInputType"]>, InferProvable<S["publicOutputType"]>>>;
