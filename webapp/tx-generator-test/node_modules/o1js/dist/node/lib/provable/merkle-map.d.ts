...
import { MerkleTree } from 'o1js/dist/node/lib/provable/merkle-tree.js';
...
declare class MerkleMap {
     ...
     * ```
     */
    get(key: Field): import("o1js/dist/node/lib/provable/field.js").Field;
    /**
     ...
     * ```
     */
    getRoot(): import("o1js/dist/node/lib/provable/field.js").Field;
    /**
...
declare class MerkleMapWitness extends CircuitValue {
     ...
     */
    computeRootAndKey(value: Field): import("o1js/dist/node/lib/provable/field.js").Field[];
}
