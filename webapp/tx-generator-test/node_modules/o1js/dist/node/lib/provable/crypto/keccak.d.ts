import { FlexibleBytes } from 'o1js/dist/node/lib/provable/bytes.js';
export { Keccak };
declare const Keccak: {
     ...
     *
     */
    nistSha3(len: 256 | 384 | 512, message: FlexibleBytes): import("o1js/dist/node/lib/provable/bytes.js").Bytes;
    /**
     ...
     * ```
     */
    ethereum(message: FlexibleBytes): import("o1js/dist/node/lib/provable/bytes.js").Bytes;
    /**
     ...
     *
     */
    preNist(len: 256 | 384 | 512, message: FlexibleBytes): import("o1js/dist/node/lib/provable/bytes.js").Bytes;
};
