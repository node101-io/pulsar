import { CurveParams, CurveAffine } from 'o1js/dist/node/bindings/crypto/elliptic-curve.js';
import { ProvablePureExtended } from 'o1js/dist/node/lib/provable/types/struct.js';
import { AlmostForeignField } from 'o1js/dist/node/lib/provable/foreign-field.js';
...
declare class ForeignCurve {
     ...
     */
    toBigint(): import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine;
    /**
    ...
    static get Bigint(): {
        ...
        readonly Endo: {
            ...
            endomorphism(P: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine): {
                x: bigint;
                y: bigint;
            };
            scaleProjective(g: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupProjective, s: bigint): {
                x: bigint;
                y: bigint;
                z: bigint;
            };
            scale(g: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine, s: bigint): import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine;
        };
        from(g: {
            x: bigint;
            y: bigint;
        }): import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine;
        fromNonzero(g: {
            x: bigint;
            y: bigint;
        }): import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine;
        equal(g: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine, h: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine): boolean;
        isOnCurve(g: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine): boolean;
        isInSubgroup(g: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine): boolean;
        add(g: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine, h: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine): import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine;
        double(g: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine): import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine;
        negate(g: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine): import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine;
        sub(g: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine, h: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine): import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine;
        scale(g: import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine, s: bigint | boolean[]): import("o1js/dist/node/bindings/crypto/elliptic-curve.js").GroupAffine;
    };
    /**
