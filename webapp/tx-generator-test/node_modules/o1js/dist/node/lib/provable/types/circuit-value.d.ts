...
import { HashInput, NonMethods } from 'o1js/dist/node/lib/provable/types/provable-derivers.js';
import { AnyConstructor, FlexibleProvable } from 'o1js/dist/node/lib/provable/types/struct.js';
...
declare abstract class CircuitValue {
    ...
    toJSON(): any;
    toConstant(): this;
    equals(x: this): import("o1js/dist/node/lib/provable/bool.js").Bool;
