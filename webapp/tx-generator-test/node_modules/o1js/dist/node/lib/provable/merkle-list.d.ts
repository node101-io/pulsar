...
import { ProvableHashable } from 'o1js/dist/node/lib/provable/crypto/poseidon.js';
import { Unconstrained } from 'o1js/dist/node/lib/provable/types/unconstrained.js';
import { WithProvable } from 'o1js/dist/node/lib/provable/types/provable-intf.js';
import { Option } from 'o1js/dist/node/lib/provable/option.js';
...
declare class MerkleList<T> implements MerkleListBase<T> {
     ...
     * ```
     */
    static create<T>(type: WithProvable<ProvableHashable<T>>, nextHash?: (hash: Field, value: T) => Field, emptyHash_?: import("o1js/dist/node/lib/provable/field.js").Field): typeof MerkleList<T> & {
        empty: () => MerkleList<T>;
    ...
    static get emptyHash(): import("o1js/dist/node/lib/provable/field.js").Field;
...
declare class MerkleListIterator<T> implements MerkleListIteratorBase<T> {
    ...
    assertAtStart(): void;
    isAtEnd(): import("o1js/dist/node/lib/provable/bool.js").Bool;
    jumpToEnd(): void;
    jumpToEndIf(condition: Bool): void;
    assertAtEnd(message?: string): void;
    isAtStart(): import("o1js/dist/node/lib/provable/bool.js").Bool;
    jumpToStart(): void;
     ...
     */
    static create<T>(type: WithProvable<ProvableHashable<T>>, nextHash?: (hash: Field, value: T) => Field, emptyHash_?: import("o1js/dist/node/lib/provable/field.js").Field): typeof MerkleListIterator<T> & {
    ...
    static createFromList<T>(merkleList: typeof MerkleList<T>): {
         ...
         * Create a Merkle array type
         */
        create<T_1>(type: WithProvable<ProvableHashable<T_1>>, nextHash?: (hash: import("o1js/dist/node/lib/provable/field.js").Field, value: T_1) => import("o1js/dist/node/lib/provable/field.js").Field, emptyHash_?: import("o1js/dist/node/lib/provable/field.js").Field): {
            new (value: MerkleListIteratorBase<T_1>): MerkleListIterator<T_1>;
            create<T_1>(type: WithProvable<ProvableHashable<T_1>>, nextHash?: (hash: import("o1js/dist/node/lib/provable/field.js").Field, value: T_1) => import("o1js/dist/node/lib/provable/field.js").Field, emptyHash_?: import("o1js/dist/node/lib/provable/field.js").Field): any & {
            ...
            _nextHash: ((hash: import("o1js/dist/node/lib/provable/field.js").Field, value: any) => import("o1js/dist/node/lib/provable/field.js").Field) | undefined;
...
declare function genericHash<T>(provable: ProvableHashable<T>, prefix: string, value: T): import("o1js/dist/node/lib/provable/field.js").Field;
declare function merkleListHash<T>(provable: ProvableHashable<T>, prefix?: string): (hash: Field, value: T) => import("o1js/dist/node/lib/provable/field.js").Field;
