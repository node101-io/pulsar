import { Bytes } from 'o1js/dist/node/lib/provable/wrapped-classes.js';
export { Hash };
/**
...
declare const Hash: {
     ...
     */
    hash: (input: import("o1js/dist/node/lib/provable/field.js").Field[]) => import("o1js/dist/node/lib/provable/field.js").Field;
    /**
    ...
    Poseidon: {
        hash(input: import("o1js/dist/node/lib/provable/field.js").Field[]): import("o1js/dist/node/lib/provable/field.js").Field;
        update(state: [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field], input: import("o1js/dist/node/lib/provable/field.js").Field[]): [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field];
        hashWithPrefix(prefix: string, input: import("o1js/dist/node/lib/provable/field.js").Field[]): import("o1js/dist/node/lib/provable/field.js").Field;
        initialState(): [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field];
        Unsafe: {
            hashToGroup(input: import("o1js/dist/node/lib/provable/field.js").Field[]): import("o1js/dist/node/lib/provable/group.js").Group;
        };
        hashToGroup(input: import("o1js/dist/node/lib/provable/field.js").Field[]): import("o1js/dist/node/lib/provable/group.js").Group;
        hashPacked<T>(type: import("o1js/dist/node/lib/provable/types/provable-intf.js").WithProvable<{
            toInput: (x: T) => import("o1js/dist/node/lib/provable/crypto/poseidon.js").HashInput;
            empty: () => T;
        }>, value: T): import("o1js/dist/node/lib/provable/field.js").Field;
        Sponge: {
            new (): {
                "__#2@#sponge": unknown;
                absorb(x: import("o1js/dist/node/lib/provable/field.js").Field): void;
                squeeze(): import("o1js/dist/node/lib/provable/field.js").Field;
            };
        };
    };
    /**
    ...
    SHA3_256: {
         ...
         */
        hash(bytes: Bytes): import("o1js/dist/node/lib/provable/bytes.js").Bytes;
    };
    /**
