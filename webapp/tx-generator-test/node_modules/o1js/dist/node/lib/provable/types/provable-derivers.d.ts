import { Provable, ProvableHashable, ProvablePure, ProvableType, ToProvable } from 'o1js/dist/node/lib/provable/types/provable-intf.js';
import type { Field } from 'o1js/dist/node/lib/provable/wrapped.js';
import { NonMethods, InferProvable as GenericInferProvable, InferJson, InferredProvable as GenericInferredProvable, IsPure as GenericIsPure, NestedProvable as GenericNestedProvable, Constructor, InferValue, InferJsonNested, InferValueNested, InferProvableNested } from 'o1js/dist/node/bindings/lib/provable-generic.js';
import { Tuple } from 'o1js/dist/node/lib/util/types.js';
import { GenericHashInput } from 'o1js/dist/node/bindings/lib/generic.js';
export { ProvableExtended, ProvableInferPureFrom, provable, provablePure, provableTuple, provableFromClass, provableExtends, };
export { NonMethods, HashInput, InferProvable, InferProvableType, InferJson, InferredProvable, IsPure, NestedProvable, mapValue, };
...
declare const HashInput: {
    readonly empty: {};
    append(input1: GenericHashInput<import("o1js/dist/node/lib/provable/field.js").Field>, input2: GenericHashInput<import("o1js/dist/node/lib/provable/field.js").Field>): GenericHashInput<import("o1js/dist/node/lib/provable/field.js").Field>;
};
type NestedProvable = GenericNestedProvable<Field>;
declare const provable: import("o1js/dist/node/bindings/lib/provable-generic.js").ProvableConstructor<import("o1js/dist/node/lib/provable/field.js").Field>;
...
declare function provableExtends<A extends ProvableHashable<any>, T extends InferProvable<A>, S extends T>(S: new (t: T) => S, base: A): {
    sizeInFields(): number;
    toFields(value: S | T): import("o1js/dist/node/lib/provable/field.js").Field[];
    toAuxiliary(value?: S | T): any[];
    fromFields(fields: import("o1js/dist/node/lib/provable/field.js").Field[], aux: any[]): S;
...
declare function mapValue<A extends ProvableHashable<any>, V extends InferValue<A>, W, T extends InferProvable<A>>(provable: A, there: (x: V) => W, back: (x: W | T) => V | T): ProvableHashable<T, W>;
