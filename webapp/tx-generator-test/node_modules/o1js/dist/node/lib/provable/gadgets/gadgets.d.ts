...
import { Field3, Sum as ForeignFieldSum } from 'o1js/dist/node/lib/provable/gadgets/foreign-field.js';
import { divMod32, addMod32, divMod64, addMod64 } from 'o1js/dist/node/lib/provable/gadgets/arithmetic.js';
import { arrayGet, arrayGetGeneric } from 'o1js/dist/node/lib/provable/gadgets/basic.js';
import { sliceField3 } from 'o1js/dist/node/lib/provable/gadgets/bit-slices.js';
...
declare const Gadgets: {
     ...
     */
    rangeCheck64(x: Field): [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field];
    /**
     ...
     * ```
     */
    isDefinitelyInRangeN(n: number, x: Field): import("o1js/dist/node/lib/provable/bool.js").Bool;
     ...
     * ```
     */
    rotate64(field: Field, bits: number, direction?: 'left' | 'right'): import("o1js/dist/node/lib/provable/field.js").Field;
    /**
     * A (left and right) rotation operates similarly to the shift operation (`<<` for left and `>>` for right) in JavaScript,
     ...
     * ```
     */
    rotate32(field: Field, bits: number, direction?: 'left' | 'right'): import("o1js/dist/node/lib/provable/field.js").Field;
    /**
     ...
     * ```
     */
    xor(a: Field, b: Field, length: number): import("o1js/dist/node/lib/provable/field.js").Field;
    /**
     ...
     */
    not(a: Field, length: number, checked?: boolean): import("o1js/dist/node/lib/provable/field.js").Field;
    /**
     ...
     * ```
     */
    leftShift64(field: Field, bits: number): import("o1js/dist/node/lib/provable/field.js").Field;
    /**
     * Performs a left shift operation on the provided {@link Field} element.
     * This operation is similar to the `<<` shift operation in JavaScript,
     * where bits are shifted to the left, and the overflowing bits are discarded.
     ...
     * ```
     */
    leftShift32(field: Field, bits: number): import("o1js/dist/node/lib/provable/field.js").Field;
    /**
     ...
     * ```
     */
    rightShift64(field: Field, bits: number): import("o1js/dist/node/lib/provable/field.js").Field;
    /**
     ...
     * ```
     */
    and(a: Field, b: Field, length: number): import("o1js/dist/node/lib/provable/field.js").Field;
    /**
     ...
     * ```
     */
    or(a: Field, b: Field, length: number): import("o1js/dist/node/lib/provable/field.js").Field;
    /**
     * Multi-range check.
     *
     ...
     */
    compactMultiRangeCheck(xy: Field, z: Field): [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field];
    /**
    ...
    ForeignField: {
         ...
         */
        equals(x: Field3, c: bigint, f: bigint): import("o1js/dist/node/lib/provable/bool.js").Bool;
        /**
    ...
    Field3: {
        ...
        toBigints<T extends import("o1js/dist/node/lib/util/types.js").Tuple<Field3>>(...xs: T): [...{ [i in keyof T]: bigint; }];
        isConstant(x: Field3): boolean;
        provable: {
            toValue(x: Field3): bigint;
            fromValue(x: bigint | Field3): Field3;
            toFields: (x: [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field]) => import("o1js/dist/node/lib/provable/field.js").Field[];
            toAuxiliary: (x?: [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field] | undefined) => any[];
            sizeInFields: () => number;
            check: (x: [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field]) => void;
            toCanonical?: ((x: [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field]) => [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field]) | undefined;
            fromFields: (x: import("o1js/dist/node/lib/provable/field.js").Field[]) => [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field];
            toInput: (x: [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field]) => {
            ...
            toJSON: (x: [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field]) => [any, any, any];
            /**
             * Get value from array at a Field element index, in O(n) constraints, where n is the array length.
             *
             * **Warning**: This gadget assumes that the index is within the array bounds `[0, n)`,
             ...
             * **Note**: This saves n constraints compared to `Provable.switch(array.map((_, i) => index.equals(i)), type, array)`.
             */
            fromJSON: (x: [any, any, any]) => [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field];
            empty: () => [import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field];
        };
        split: typeof import("o1js/dist/node/lib/provable/gadgets/foreign-field.js").split;
    };
    /**
     ...
     */
    SHA256: {
        hash(data: import("o1js/dist/node/lib/provable/bytes.js").FlexibleBytes): import("o1js/dist/node/lib/provable/bytes.js").Bytes;
        compression: ([...H]: import("o1js/dist/node/lib/provable/int.js").UInt32[], W: import("o1js/dist/node/lib/provable/int.js").UInt32[]) => import("o1js/dist/node/lib/provable/int.js").UInt32[];
        createMessageSchedule: (M: import("o1js/dist/node/lib/provable/int.js").UInt32[]) => import("o1js/dist/node/lib/provable/int.js").UInt32[];
        padding: (data: import("o1js/dist/node/lib/provable/bytes.js").FlexibleBytes) => import("o1js/dist/node/lib/provable/int.js").UInt32[][];
        readonly initialState: import("o1js/dist/node/lib/provable/int.js").UInt32[];
    };
    /**
     ...
     *   */
    SHA2: {
        hash<T_1 extends 256 | 512 | 224 | 384>(length: T_1, data: import("o1js/dist/node/lib/provable/bytes.js").FlexibleBytes): import("o1js/dist/node/lib/provable/bytes.js").Bytes;
        compression: <T_2 extends import("o1js/dist/node/lib/provable/int.js").UInt64 | import("o1js/dist/node/lib/provable/int.js").UInt32>(length: 256 | 512 | 224 | 384, [...H]: T_2[], W: T_2[]) => T_2[];
        messageSchedule: <T_3 extends import("o1js/dist/node/lib/provable/int.js").UInt64 | import("o1js/dist/node/lib/provable/int.js").UInt32>(length: 256 | 512 | 224 | 384, M: T_3[]) => T_3[];
        padding: <T_4 extends import("o1js/dist/node/lib/provable/int.js").UInt64 | import("o1js/dist/node/lib/provable/int.js").UInt32>(length: 256 | 512 | 224 | 384, data: import("o1js/dist/node/lib/provable/bytes.js").FlexibleBytes) => T_4[][];
        initialState<T_5 extends import("o1js/dist/node/lib/provable/int.js").UInt64 | import("o1js/dist/node/lib/provable/int.js").UInt32>(length: 256 | 512 | 224 | 384): T_5[];
    };
    /**
     ...
     */
    BLAKE2B: {
        hash(data: import("o1js/dist/node/lib/provable/bytes.js").FlexibleBytes, digestLength?: number): import("o1js/dist/node/lib/provable/bytes.js").Bytes;
        readonly IV: import("o1js/dist/node/lib/provable/int.js").UInt64[];
    };
    /**
