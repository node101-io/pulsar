...
import { AnyConstructor } from 'o1js/dist/node/lib/provable/types/struct.js';
import { Types } from 'o1js/dist/node/bindings/mina-transaction/v1/types.js';
import * as TypesBigint from 'o1js/dist/node/bindings/mina-transaction/v1/transaction-leaves-bigint.js';
import { HashInput } from 'o1js/dist/node/lib/provable/crypto/poseidon.js';
import { FieldVar } from 'o1js/dist/node/lib/provable/core/fieldvar.js';
import { CircuitValue } from 'o1js/dist/node/lib/provable/types/circuit-value.js';
...
declare class UInt64 extends CircuitValue {
     ...
     */
    lessThanOrEqual(y: UInt64): import("o1js/dist/node/lib/provable/bool.js").Bool;
    /**
     ...
     */
    lessThan(y: UInt64): import("o1js/dist/node/lib/provable/bool.js").Bool;
    /**
     ...
     */
    greaterThan(y: UInt64): import("o1js/dist/node/lib/provable/bool.js").Bool;
    /**
     ...
     */
    greaterThanOrEqual(y: UInt64): import("o1js/dist/node/lib/provable/bool.js").Bool;
    /**
     ...
     */
    toBits(length?: number): import("o1js/dist/node/lib/provable/bool.js").Bool[];
    /**
...
declare class UInt32 extends CircuitValue {
     ...
     */
    lessThanOrEqual(y: UInt32): import("o1js/dist/node/lib/provable/bool.js").Bool;
    /**
     ...
     */
    lessThan(y: UInt32): import("o1js/dist/node/lib/provable/bool.js").Bool;
    /**
     ...
     */
    greaterThan(y: UInt32): import("o1js/dist/node/lib/provable/bool.js").Bool;
    /**
     ...
     */
    greaterThanOrEqual(y: UInt32): import("o1js/dist/node/lib/provable/bool.js").Bool;
    /**
...
declare class Sign extends CircuitValue {
    ...
    neg(): Sign;
    mul(y: Sign): Sign;
    isPositive(): import("o1js/dist/node/lib/provable/bool.js").Bool;
    isNegative(): import("o1js/dist/node/lib/provable/bool.js").Bool;
    toString(): string;
...
declare class Int64 extends CircuitValue implements BalanceChange {
     ...
     */
    toField(): import("o1js/dist/node/lib/provable/field.js").Field;
    /**
     ...
     */
    equals(y: Int64 | number | string | bigint | UInt64 | UInt32): import("o1js/dist/node/lib/provable/bool.js").Bool;
    /**
     ...
     */
    isNonNegative(): import("o1js/dist/node/lib/provable/bool.js").Bool;
    /**
...
declare class UInt8 extends UInt8_base {
     ...
     * ```
     */
    greaterThan(y: UInt8 | bigint | number): import("o1js/dist/node/lib/provable/bool.js").Bool;
    /**
     ...
     * ```
     */
    greaterThanOrEqual(y: UInt8 | bigint | number): import("o1js/dist/node/lib/provable/bool.js").Bool;
    /**
