import { Field as InternalField } from 'o1js/dist/node/lib/provable/field.js';
import { Bool as InternalBool } from 'o1js/dist/node/lib/provable/bool.js';
import { Group as InternalGroup } from 'o1js/dist/node/lib/provable/group.js';
import { Scalar } from 'o1js/dist/node/lib/provable/scalar.js';
 ...
 */
declare const Field: typeof InternalField & ((x: string | number | bigint | import("o1js/dist/node/lib/provable/core/fieldvar.js").FieldConst | import("o1js/dist/node/lib/provable/core/fieldvar.js").FieldVar | InternalField) => InternalField);
 ...
 * ```
 */
declare const Bool: typeof InternalBool & ((x: boolean | import("o1js/dist/node/lib/provable/core/fieldvar.js").FieldVar | InternalBool) => InternalBool);
type Bool = InternalBool;
/**
 * An element of a Group.
 */
declare const Group: typeof InternalGroup & ((args_0: {
    x: string | number | bigint | import("o1js/dist/node/lib/provable/core/fieldvar.js").FieldVar | InternalField;
    y: string | number | bigint | import("o1js/dist/node/lib/provable/core/fieldvar.js").FieldVar | InternalField;
}) => InternalGroup);
