  ...
  const handleBridge = async () => {
    ...
    if (activeTab === "deposit") {
      try {
        ...
        toast.success(
          `Deposit transaction submitted! Hash: ${result.hash.slice(0, 10)}...`
        );
        ...
        console.error(err);
        toast.error(err?.message || "Failed to send deposit transaction");
        setIsTransacting(false);
        return;
      }
        ...
        <div className="rounded-2xl border-1 border-black bg-text p-5 relative flex flex-col">
          ...
          <div className="flex items-center justify-between mb-1.5">
            <input
              ...
              step="1.000"
              placeholder="0.000"
              className="w-full pr-5 text-2xl text-background focus:outline-none leading-none"
              type="number"
              value={amount}
              onChange={(e) => {
          ...
          <div className="flex gap-2 font-family-darker-grotesque font-medium">
            {hasError && (
              <div className="leading-none text-[#B40000]">
                Insufficient {activeTab === "deposit" ? "MINA" : "pMINA"}{" "}
                balance
              </div>
            )}
            <div
              className="leading-none ml-auto text-background cursor-pointer"
          ...
          <div className="overflow-hidden">
            <div className="flex flex-col gap-5 items-center justify-between rounded-2xl border-1 border-black bg-text p-5 pb-4">
              <div className="flex gap-2 w-full items-center justify-between">
                <span className="text-2xl text-background leading-none">
                  You Will
                  <br />
                  Receive
                </span>
                <div className="flex flex-col items-end">
                  <span className="text-background leading-none">
                    {(Number(amount) - gasFee).toFixed(3)}{" "}
                    {activeTab === "deposit" ? "pMINA" : "MINA"}
                  </span>
                  <span className="text-background leading-none font-family-darker-grotesque">
                    ~$
                    {(
              ...
              <div className="flex gap-2 items-center w-full">
                ...
                <span className="text-sm text-background leading-none mr-auto mt-1">
                  ~2.5 Hours
                </span>
                <label
                  htmlFor="gas-fee"
                ...
                >
                  ...
                  <Image
                    ...
                    width={11}
                    height={11}
                    className="peer-checked/gas-fee:rotate-90 transition-all duration-300 mr-2 peer-checked/gas-fee:mr-0"
                  />
                  <div
                    className={cn(
                  ...
                  >
                    <div className="overflow-hidden">
                      <span className="text-nowrap text-base font-medium text-background leading-none font-family-darker-grotesque mb-1">
                        {gasFee.toFixed(3)} pMINA
                      </span>
                    </div>
                  </div>
                </label>
