...
function createBasePulsarAction(): PulsarAction {
  return { publicKey: "", amount: "", actionType: "", cosmosAddress: "", cosmosSignature: "" };
}
...
export const PulsarAction: MessageFns<PulsarAction> = {
  encode(message: PulsarAction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.cosmosAddress !== "") {
      writer.uint32(34).string(message.cosmosAddress);
    }
    if (message.cosmosSignature !== "") {
      writer.uint32(42).string(message.cosmosSignature);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.cosmosSignature = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): PulsarAction {
    return {
      ...
      cosmosSignature: isSet(object.cosmosSignature) ? globalThis.String(object.cosmosSignature) : "",
    };
  },
  ...
  toJSON(message: PulsarAction): unknown {
    ...
    if (message.cosmosSignature !== "") {
      obj.cosmosSignature = message.cosmosSignature;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<PulsarAction>, I>>(object: I): PulsarAction {
    ...
    message.cosmosSignature = object.cosmosSignature ?? "";
    return message;
  },
};
  ...
  fromJSON(object: any): BridgeState {
    return {
      ...
      approvedActions: globalThis.Array.isArray(object?.approvedActions)
        ...
        : [],
      approvedActionHash: isSet(object.approvedActionHash) ? globalThis.String(object.approvedActionHash) : "",
      allActionHash: isSet(object.allActionHash) ? globalThis.String(object.allActionHash) : "",
      settledBlockHeight: isSet(object.settledBlockHeight) ? globalThis.String(object.settledBlockHeight) : "0",
    };
  },
