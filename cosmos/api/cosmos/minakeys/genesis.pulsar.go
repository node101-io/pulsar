...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.KeyStoreList) != 0 {
		value := protoreflect.ValueOfList(&_GenesisState_2_list{list: &x.KeyStoreList})
		if !f(fd_GenesisState_keyStoreList, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.minakeys.GenesisState.keyStoreList":
		if x.KeyStoreList == nil {
			x.KeyStoreList = []*KeyStore{}
		}
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.KeyStoreList) > 0 {
			for iNdEx := len(x.KeyStoreList) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.KeyStoreList[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field KeyStoreList", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.KeyStoreList = append(x.KeyStoreList, &KeyStore{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.KeyStoreList[len(x.KeyStoreList)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
func (x *GenesisState) GetKeyStoreList() []*KeyStore {
	if x != nil {
		return x.KeyStoreList
	}
	return nil
}
...
var file_cosmos_minakeys_genesis_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x43, 0x0a, 0x0c, 0x6b, 0x65, 0x79, 0x53, 0x74, 0x6f, 0x72,
