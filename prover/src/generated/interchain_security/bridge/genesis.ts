...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, bridgeState: undefined };
}
...
export const GenesisState: MessageFns<GenesisState> = {
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.bridgeState !== undefined) {
      BridgeState.encode(message.bridgeState, writer.uint32(18).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      bridgeState: isSet(object.bridgeState) ? BridgeState.fromJSON(object.bridgeState) : undefined,
    };
  },
