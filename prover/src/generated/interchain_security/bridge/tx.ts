...
export const MsgLockForWithdrawal: MessageFns<MsgLockForWithdrawal> = {
    ...
    fromJSON(object: any): MsgLockForWithdrawal {
        return {
            ...
            minaPublicKey: isSet(object.minaPublicKey)
                ? globalThis.String(object.minaPublicKey)
                : "",
    ...
    fromPartial<I extends Exact<DeepPartial<MsgLockForWithdrawal>, I>>(
        object: I
...
export const MsgLockForWithdrawalResponse: MessageFns<MsgLockForWithdrawalResponse> = {
    encode(
        _: MsgLockForWithdrawalResponse,
    ...
    create<I extends Exact<DeepPartial<MsgLockForWithdrawalResponse>, I>>(
        base?: I
    ): MsgLockForWithdrawalResponse {
        return MsgLockForWithdrawalResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<MsgLockForWithdrawalResponse>, I>>(
        _: I
    ): MsgLockForWithdrawalResponse {
        const message = createBaseMsgLockForWithdrawalResponse();
        return message;
    ...
    fromJSON(object: any): MsgResolveActions {
        return {
            ...
            actions: globalThis.Array.isArray(object?.actions)
                ...
                : [],
            nextBlockHeight: isSet(object.nextBlockHeight)
                ? globalThis.String(object.nextBlockHeight)
                : "0",
            merkleWitness: isSet(object.merkleWitness)
                ? globalThis.String(object.merkleWitness)
                : "",
        };
    },
...
export const MsgResolveActionsResponse: MessageFns<MsgResolveActionsResponse> = {
    ...
    fromJSON(object: any): MsgResolveActionsResponse {
        return {
            processedActionsCount: isSet(object.processedActionsCount)
                ...
                : "0",
            approvedActionsCount: isSet(object.approvedActionsCount)
                ? globalThis.String(object.approvedActionsCount)
                : "0",
            ignoredActionsCount: isSet(object.ignoredActionsCount)
                ? globalThis.String(object.ignoredActionsCount)
                : "0",
        };
    },
    ...
    create<I extends Exact<DeepPartial<MsgResolveActionsResponse>, I>>(
        base?: I
    ): MsgResolveActionsResponse {
        return MsgResolveActionsResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<MsgResolveActionsResponse>, I>>(
        object: I
    ): MsgResolveActionsResponse {
        const message = createBaseMsgResolveActionsResponse();
...
export const MsgService = {
    ...
    lockForWithdrawal: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value: MsgLockForWithdrawal) =>
            Buffer.from(MsgLockForWithdrawal.encode(value).finish()),
    ...
    resolveActions: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value: MsgResolveActions) =>
            Buffer.from(MsgResolveActions.encode(value).finish()),
...
export const MsgClient = makeGenericClientConstructor(
    MsgService,
    "interchain_security.bridge.Msg"
) as unknown as {
    new (
        address: string,
