...
function createBaseGlobalSlashEntry(): GlobalSlashEntry {
  return { recvTime: undefined, consumerChainId: "", ibcSeqNum: "0", providerValConsAddr: Buffer.alloc(0) };
}
...
export const GlobalSlashEntry: MessageFns<GlobalSlashEntry> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.providerValConsAddr = Buffer.from(reader.bytes());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GlobalSlashEntry {
    return {
      ...
      providerValConsAddr: isSet(object.providerValConsAddr)
        ? Buffer.from(bytesFromBase64(object.providerValConsAddr))
        : Buffer.alloc(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GlobalSlashEntry>, I>>(object: I): GlobalSlashEntry {
    ...
    message.providerValConsAddr = object.providerValConsAddr ?? Buffer.alloc(0);
    return message;
  },
};
...
function createBaseKeyAssignmentReplacement(): KeyAssignmentReplacement {
  return { providerAddr: Buffer.alloc(0), prevCKey: undefined, power: "0" };
}
...
export const KeyAssignmentReplacement: MessageFns<KeyAssignmentReplacement> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.providerAddr = Buffer.from(reader.bytes());
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): KeyAssignmentReplacement {
    return {
      providerAddr: isSet(object.providerAddr) ? Buffer.from(bytesFromBase64(object.providerAddr)) : Buffer.alloc(0),
  ...
  fromPartial<I extends Exact<DeepPartial<KeyAssignmentReplacement>, I>>(object: I): KeyAssignmentReplacement {
    const message = createBaseKeyAssignmentReplacement();
    message.providerAddr = object.providerAddr ?? Buffer.alloc(0);
...
function createBaseValidatorConsumerPubKey(): ValidatorConsumerPubKey {
  return { chainId: "", providerAddr: Buffer.alloc(0), consumerKey: undefined };
}
...
function createBaseValidatorByConsumerAddr(): ValidatorByConsumerAddr {
  return { chainId: "", consumerAddr: Buffer.alloc(0), providerAddr: Buffer.alloc(0) };
}
...
export const ValidatorByConsumerAddr: MessageFns<ValidatorByConsumerAddr> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.consumerAddr = Buffer.from(reader.bytes());
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromJSON(object: any): ValidatorByConsumerAddr {
    return {
      chainId: isSet(object.chainId) ? globalThis.String(object.chainId) : "",
      consumerAddr: isSet(object.consumerAddr) ? Buffer.from(bytesFromBase64(object.consumerAddr)) : Buffer.alloc(0),
      providerAddr: isSet(object.providerAddr) ? Buffer.from(bytesFromBase64(object.providerAddr)) : Buffer.alloc(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ValidatorByConsumerAddr>, I>>(object: I): ValidatorByConsumerAddr {
    const message = createBaseValidatorByConsumerAddr();
    message.chainId = object.chainId ?? "";
    message.consumerAddr = object.consumerAddr ?? Buffer.alloc(0);
    message.providerAddr = object.providerAddr ?? Buffer.alloc(0);
    return message;
  },
};
...
function createBaseConsumerValidator(): ConsumerValidator {
  return { providerConsAddr: Buffer.alloc(0), power: "0", consumerPublicKey: undefined, joinHeight: "0" };
}
...
export const ConsumerValidator: MessageFns<ConsumerValidator> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.providerConsAddr = Buffer.from(reader.bytes());
          continue;
        }
        case 2: {
          if (tag !== 16) {
  ...
  fromJSON(object: any): ConsumerValidator {
    return {
      providerConsAddr: isSet(object.providerConsAddr)
        ? Buffer.from(bytesFromBase64(object.providerConsAddr))
        : Buffer.alloc(0),
      power: isSet(object.power) ? globalThis.String(object.power) : "0",
  ...
  fromPartial<I extends Exact<DeepPartial<ConsumerValidator>, I>>(object: I): ConsumerValidator {
    const message = createBaseConsumerValidator();
    message.providerConsAddr = object.providerConsAddr ?? Buffer.alloc(0);
    message.power = object.power ?? "0";
