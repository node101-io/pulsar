    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.appStateBytes = Buffer.from(reader.bytes());
          continue;
        }
        case 6: {
          if (tag !== 48) {
...
export const RequestPrepareProposal: MessageFns<RequestPrepareProposal> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.maxTxBytes = reader.int64().toString();
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): RequestPrepareProposal {
    return {
      maxTxBytes: isSet(object.maxTxBytes) ? globalThis.String(object.maxTxBytes) : "0",
  ...
  toJSON(message: RequestPrepareProposal): unknown {
    const obj: any = {};
    if (message.maxTxBytes !== "0") {
      obj.maxTxBytes = message.maxTxBytes;
    }
...
function createBaseRequestExtendVote(): RequestExtendVote {
  return { hash: Buffer.alloc(0), height: "0" };
}
...
function createBaseRequestVerifyVoteExtension(): RequestVerifyVoteExtension {
  return { hash: Buffer.alloc(0), validatorAddress: Buffer.alloc(0), height: "0", voteExtension: Buffer.alloc(0) };
}
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.voteExtension = Buffer.from(reader.bytes());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): RequestVerifyVoteExtension {
    return {
      ...
      validatorAddress: isSet(object.validatorAddress)
        ...
        : Buffer.alloc(0),
      height: isSet(object.height) ? globalThis.String(object.height) : "0",
      voteExtension: isSet(object.voteExtension) ? Buffer.from(bytesFromBase64(object.voteExtension)) : Buffer.alloc(0),
    };
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.lastBlockAppHash = Buffer.from(reader.bytes());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const ResponseCommit: MessageFns<ResponseCommit> = {
  ...
  fromJSON(object: any): ResponseCommit {
    return { retainHeight: isSet(object.retainHeight) ? globalThis.String(object.retainHeight) : "0" };
  },
...
function createBaseExtendedVoteInfo(): ExtendedVoteInfo {
  return { validator: undefined, voteExtension: Buffer.alloc(0), extensionSignature: Buffer.alloc(0), blockIdFlag: 0 };
}
...
export type ABCIService = typeof ABCIService;
export const ABCIService = {
  echo: {
  ...
  prepareProposal: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RequestPrepareProposal) => Buffer.from(RequestPrepareProposal.encode(value).finish()),
    requestDeserialize: (value: Buffer) => RequestPrepareProposal.decode(value),
    responseSerialize: (value: ResponsePrepareProposal) => Buffer.from(ResponsePrepareProposal.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ResponsePrepareProposal.decode(value),
  },
  processProposal: {
    path: "/tendermint.abci.ABCI/ProcessProposal",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RequestProcessProposal) => Buffer.from(RequestProcessProposal.encode(value).finish()),
    requestDeserialize: (value: Buffer) => RequestProcessProposal.decode(value),
    responseSerialize: (value: ResponseProcessProposal) => Buffer.from(ResponseProcessProposal.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ResponseProcessProposal.decode(value),
  },
  extendVote: {
    path: "/tendermint.abci.ABCI/ExtendVote",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RequestExtendVote) => Buffer.from(RequestExtendVote.encode(value).finish()),
    requestDeserialize: (value: Buffer) => RequestExtendVote.decode(value),
    responseSerialize: (value: ResponseExtendVote) => Buffer.from(ResponseExtendVote.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ResponseExtendVote.decode(value),
  },
  verifyVoteExtension: {
    path: "/tendermint.abci.ABCI/VerifyVoteExtension",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RequestVerifyVoteExtension) =>
      Buffer.from(RequestVerifyVoteExtension.encode(value).finish()),
    requestDeserialize: (value: Buffer) => RequestVerifyVoteExtension.decode(value),
    responseSerialize: (value: ResponseVerifyVoteExtension) =>
      Buffer.from(ResponseVerifyVoteExtension.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ResponseVerifyVoteExtension.decode(value),
  },
  finalizeBlock: {
    path: "/tendermint.abci.ABCI/FinalizeBlock",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RequestFinalizeBlock) => Buffer.from(RequestFinalizeBlock.encode(value).finish()),
    requestDeserialize: (value: Buffer) => RequestFinalizeBlock.decode(value),
    responseSerialize: (value: ResponseFinalizeBlock) => Buffer.from(ResponseFinalizeBlock.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ResponseFinalizeBlock.decode(value),
  },
} as const;

export interface ABCIServer extends UntypedServiceImplementation {
  ...
  prepareProposal: handleUnaryCall<RequestPrepareProposal, ResponsePrepareProposal>;
  processProposal: handleUnaryCall<RequestProcessProposal, ResponseProcessProposal>;
  extendVote: handleUnaryCall<RequestExtendVote, ResponseExtendVote>;
  verifyVoteExtension: handleUnaryCall<RequestVerifyVoteExtension, ResponseVerifyVoteExtension>;
  finalizeBlock: handleUnaryCall<RequestFinalizeBlock, ResponseFinalizeBlock>;
}

export interface ABCIClient extends Client {
  ...
  prepareProposal(
    ...
    callback: (error: ServiceError | null, response: ResponsePrepareProposal) => void,
  ): ClientUnaryCall;
  prepareProposal(
    request: RequestPrepareProposal,
    metadata: Metadata,
  ...
  processProposal(
    ...
    callback: (error: ServiceError | null, response: ResponseProcessProposal) => void,
  ): ClientUnaryCall;
  processProposal(
    request: RequestProcessProposal,
    metadata: Metadata,
  ...
  extendVote(
    ...
    callback: (error: ServiceError | null, response: ResponseExtendVote) => void,
  ): ClientUnaryCall;
  extendVote(
    request: RequestExtendVote,
    metadata: Metadata,
  ...
  verifyVoteExtension(
    ...
    callback: (error: ServiceError | null, response: ResponseVerifyVoteExtension) => void,
  ): ClientUnaryCall;
  verifyVoteExtension(
    request: RequestVerifyVoteExtension,
    metadata: Metadata,
  ...
  finalizeBlock(
    ...
    callback: (error: ServiceError | null, response: ResponseFinalizeBlock) => void,
  ): ClientUnaryCall;
  finalizeBlock(
    request: RequestFinalizeBlock,
    metadata: Metadata,
...
export const ABCIClient = makeGenericClientConstructor(ABCIService, "tendermint.abci.ABCI") as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): ABCIClient;
  service: typeof ABCIService;
  serviceName: string;
};
